...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \onslide<3>Or not barley at all\\\includegraphics[width=\textwidth]{koji.jpg}
  \end{overprint}
\end{frame}
...
\begin{frame}<1-2>[label=diag]
  ...
  \begin{overprint}
    \onslide<1>\includegraphics[width=\textwidth]{beerprocess.jpg}
    \onslide<2->\includegraphics[width=\textwidth]{beerprocesszoom.png}\\
  \end{overprint}
\end{frame}
...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<1>\centering \includegraphics[height=0.8\textheight]{amylase.jpg}\hbox{\textgreek{α}-amylase}\\
    \onslide<2>\centering amylose\includegraphics[width=0.8\textwidth]{amylose.pdf}\\
    \onslide<3>\centering dextrin\includegraphics[height=0.8\textheight]{dextrin.pdf}\\
    \onslide<4>\centering maltose\includegraphics[height=0.4\textheight]{maltose.pdf}\\
  \end{overprint}
\end{frame}
